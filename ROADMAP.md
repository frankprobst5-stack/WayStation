...
- **Phase D — Incident operations.** 🔲 **Started, 3 of 5 slices done, 2026-09-02.** Slice 1: real multi-incident lifecycle plus `incident_id` tagging on messages/markers. Slice 2: `personnel` table with status + incident assignment. Slice 3: `resource_requests` with a real fulfillment lifecycle. **Not done yet:** structured SITREP, operational timeline, tactical map driven by incident objects instead of independent pin layers.
...
7. **Phase D — Incident operations** — the current focus. Slices 1–3 (incident lifecycle + tagging, personnel, resource requests) done 2026-09-02; structured SITREP, operational timeline, and tactical-map-by-incident are the remaining slices.
